...
Handle(IFSelect_Signature) STEPEdit::NewSignType()
{
  Handle(StepSelect_StepType) sty = new StepSelect_StepType();
...
Handle(IFSelect_SelectSignature)  STEPEdit::NewSelectSDR ()
{
  Handle(IFSelect_SelectSignature) sel = new IFSelect_SelectSignature
    (STEPEdit::NewSignType(),"SHAPE_DEFINITION_REPRESENTATION");
...
{
  Handle(IFSelect_SelectSignature) sel = new IFSelect_SelectSignature
    (STEPEdit::NewSignType(),"MAPPED_ITEM|CONTEXT_DEPENDENT_SHAPE_REPRESENTATION",Standard_False);
...
{
  Handle(IFSelect_SelectSignature) sel = new IFSelect_SelectSignature
    (STEPEdit::NewSignType(),"SHAPE_REPRESENTATION",Standard_False);
