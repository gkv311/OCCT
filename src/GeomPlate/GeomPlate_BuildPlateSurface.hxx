...
private:
  ...
  Standard_Real myG0Error = 0.0;
  Standard_Real myG1Error = 0.0;
  Standard_Real myG2Error = 0.0;
  Standard_Integer myNbPtsOnCur = 0;
  Standard_Boolean mySurfInitIsGive = false;
  ...
  Standard_Integer myNbBounds = 0;
  Standard_Boolean myIsLinear = false;
  Standard_Boolean myFree = false;
