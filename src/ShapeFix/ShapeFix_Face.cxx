...
Standard_Boolean ShapeFix_Face::Perform() 
{
  ...
  // Skip if an earlier fix already replaced this face with a non-face (e.g. a compound):
  // the TopoDS::Face casts below would build an invalid handle over a non-face TShape.
  if (!Context().IsNull())
  {
