...
#ifndef Image_RWAppKit_HeaderFile
#define Image_RWAppKit_HeaderFile
...
//! Class for loading/storing image pixmap from/into external file using AppKit (macOS) framework.
//! Supported image formats: BMP, PNG, JPEG, TIFF, GIF.
class Image_RWAppKit : public Image_RWPixMap
{
  DEFINE_STANDARD_RTTIEXT(Image_RWAppKit, Image_RWPixMap)
public:

  //! Constructor.
  Standard_EXPORT Image_RWAppKit();
...
public:
  //! The method to wrap NSBitmapImageRep into Image_PixMap.
  //! this will also internally retain NSBitmapImageRep until Image_PixMap is used.
  Standard_EXPORT static bool WrapNSBitmap(Image_PixMap& thePixmap,
...
#endif // Image_RWAppKit_HeaderFile
