...
// =======================================================================
// function : SetShearAngle
// purpose  :
// =======================================================================
void Font_FTFont::SetShearAngle (const float theAngle)
{
  if (myShearAngle == theAngle)
    return;

  static constexpr double aTol = (M_PI / 180.0) * 0.5;
  if (Abs(M_PI_2 - Abs(theAngle)) < aTol
   || Abs(3.0 * M_PI_2 - Abs(theAngle)) < aTol
   || Abs(theAngle) >= M_PI * 2.0)
  {
